...
<div class="layui-form">
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="width: 120px">
                <input class="layui-input" name="account_id" type="text" value="" placeholder="请输入会员ID">
            </div>
        </div>
        <div class="layui-inline">
        ...
        var data_table = table.render({
            ...
            ,cols: [
                [
                    ...
                    ,{field: 'user_id', title: '用户id', width: 100, rowspan: 2}
         ...
         table.on('edit(data_table)', function (obj) {
                ...
                $.post("{{url('admin/user/wallet/edit')}}", { id: id, address: address,address_2:address_2 }, function (data) {
                    if(data.type=="ok"){
