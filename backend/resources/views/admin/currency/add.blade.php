            ...
            <div class="layui-tab-content">
                <div class="layui-tab-item layui-show">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                        <input type="number" class="layui-input" id="price" name="price" value="{{$result->price}}" placeholder="价值">
                        </div>
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="number" class="layui-input" id="rmb_relation" name="rmb_relation" value="{{$result->rmb_relation}}" placeholder="百分比">
                        </div>
                        <!-- <div class="layui-form-mid layui-word-aux">%</div> -->
                    </div>
                    <div class="layui-form-item">
                ...
                <div class="layui-tab-item">
                    <div class="layui-form-item {{$result->id == 3 ? '' : 'hide'}}">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_omni" name="address_omni" value="{{$result->address_omni}}" placeholder="地址">
                        </div>
                    </div>
                     @if ( $result->id ==3)
                    <div class="layui-form-item">
                        <label class="layui-form-label">充币地址erc20</label>
                        <div class="layui-input-block">
                            <input type="text" class="layui-input" id="address_erc" name="address_erc" value="{{$result->address_erc}}" placeholder="地址">
                        </div>
                    </div>
                    @endif
                      @if ( $result->id !=3)
