...
@section('page-content')
    <div style="margin-top: 10px;width: 100%;">
        ...
        <button class="layui-btn layui-btn-normal" style="margin-left: 10px;" onclick="javascrtpt:window.location.href='{{url('/admin/feedback/csv')}}'">导出用户</button>
    </div>
...
@section('scripts')
    <script>
        ...
        layui.use(['table','form'], function(){
            ...
            table.render({
                elem: '#demo'
                ,url: "{{url('admin/feedback/list')}}" //数据接口
                ,page: true //开启分页
                ,id:'mobileSearch'
                ,cols: [[ //表头
                    ...
                    ,{field: 'is_reply', title: '是否回复', ninWidth:80, templet: '#is_reply'}
                    ,{field: 'reply_time', title: '回复时间', ninWidth:80}
