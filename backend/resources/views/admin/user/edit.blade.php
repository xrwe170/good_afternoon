    ...
    <form class="layui-form" action="">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <select name="user_level" lay-verify="required" lay-filter="">
                    <option value=""></option>
                    <option value="0" {{ ($result->user_level ?? 0) == 0 ? 'selected' : '' }} >无</option>
                    @foreach($level as $k => $v)
                        <option value="{{@$k}}" {{ ($result->user_level ?? 0) == $k ? 'selected' : '' }} >{{@$v}}</option>
                    @endforeach
                </select>
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" name="virtual_follow_num" autocomplete="off" placeholder="" class="layui-input" value="@if(!empty($result->virtual_follow_num)){{$result->virtual_follow_num}}@endif" >
            </div>
