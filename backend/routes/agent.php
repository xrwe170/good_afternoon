...
Route::group(['prefix' => 'admin', 'middleware' => ['admin_auth']], function () {
     Route::get('/currency/project/order/view','Admin\CurrencyProjectController@projectOrderView');
        Route::get('/currency/project/order/list','Admin\CurrencyProjectController@projectOrderList');
 });
...
Route::any('agent/dojie', 'Agent\ReportController@dojie');//阶段订单图表
    ...
    Route::group(['prefix' => 'admin', 'middleware' => ['admin_auth']], function () {
        Route::post('/user/wallet/edit','Admin\AdminController@editAddress');//页面
